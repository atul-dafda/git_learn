...
import img2 from "../../../assets/img/banner/01.jpg";
...
const bannerslide = [
	{
		...
		text: "Sedut perspiciatis unde omnis iste natus error sit voluptatem accusantium /n doloremque laudanti totam raperiaeaque ipsa quaeab",
