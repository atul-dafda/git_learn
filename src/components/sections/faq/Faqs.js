					...
					<div className="row faq-page-title mb-60 align-items-center">
						...
						<div className="col-lg-6">
							<p>
								...
								easure and praising pain was born and I will give you a compl
						...
						<Card>
							...
							<Card.Header>
								<Accordion.Toggle as={Button} variant="link" eventKey="2">
									How To Build A Vue Survey App Using Firebase Authentication
									And Database Blessing Krofegha wrote ?
									<span className="icons">
										<i className="far fa-plus" />
									</span>
								</Accordion.Toggle>
						...
						<Card>
							...
							<Card.Header>
								<Accordion.Toggle as={Button} variant="link" eventKey="3">
									How To Build A Vue Survey App Using Firebase Authentication
									And Database Meet Sma Ove Online Conference ?
									<span className="icons">
										<i className="far fa-plus" />
									</span>
								</Accordion.Toggle>
						...
						<Card>
							...
							<Card.Header>
								<Accordion.Toggle as={Button} variant="link" eventKey="6">
									How To Build A Vue Survey App Using Firebase Authentication
									And Interactive Online Conference ?
									<span className="icons">
										<i className="far fa-plus" />
									</span>
								</Accordion.Toggle>
						...
						<Card>
							...
							<Card.Header>
								<Accordion.Toggle as={Button} variant="link" eventKey="7">
									How To Build A Vue Survey App Using Firebase Authentication
									And Database Join Our New Online ?
									<span className="icons">
										<i className="far fa-plus" />
									</span>
								</Accordion.Toggle>
						...
						<Card>
							...
							<Card.Header>
								<Accordion.Toggle as={Button} variant="link" eventKey="8">
									How To Build A Vue Survey App Using Firebase Authentication
									And In React Apps Using components ?
									<span className="icons">
										<i className="far fa-plus" />
									</span>
								</Accordion.Toggle>
