...
const missiontab = [
	...
	{
		icon: "fas fa-check",
		text: "We Believe In Ability ",
	},
	{
		icon: "fas fa-check",
		text: "We Believe In Relation",
	},
];
const historytab = [
	{
										...
										<div className="row align-items-center justify-content-center">
											...
											<div className="col-lg-6 col-md-10">
												<div className="block-text">
													...
													<p>
														Transforming your !DEA with excellence by combining
														our rich experience in designing and delivering
														scalable, yet powerful implementation to take you
														long way...
													</p>
													<ul>
